...
do
    cp $filename ${filename/snap/original-snap}
done
```
...
for filename in high_equilibrium/snapshots/*.txt
do
    echo "Copying $filename ..." && cp $filename ${filename/snap/original-snap} && echo "$filename copied sucessfully"
done
```
...
In our example, we named the new files as `original-$filename`.
Because we run the same loop, `for filename in high_equilibrium/snapshots/*.txt`, twice,
we would end up with files `high_equilibrium/snapshots/snap001.txt`, `high_equilibrium/snapshots/original-snap001.txt`, `high_equilibrium/snapshots/original-original-snap001.txt`, `high_equilibrium/snapshots/snap002.txt`, `high_equilibrium/snapshots/original-snap002.txt`, `high_equilibrium/snapshots/original-original-snap002.txt`, and so on.
